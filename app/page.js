...
export default function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Save account locally and redirect immediately to login
      ...
      <main style={{ display: 'flex', justifyContent: 'center', padding: '2rem 1rem' }}>
        <form onSubmit={handleSubmit} style={{ background: '#16161e', border: '1px solid #232330', borderRadius: '12px', padding: '2rem', width: '100%', maxWidth: '400px' }}>
          ...
          <div style={{ marginBottom: '1.2rem' }}>
            ...
            <input type="tel" name="mobile" value={formData.mobile} onChange={handleChange} placeholder="+977 98XXXXXXXX" required style={{ width: '100%', padding: '0.75rem', borderRadius: '6px', border: '1px solid #232330', background: '#0d0d11', color: '#fff', boxSizing: 'border-box' }} />
          </div>
